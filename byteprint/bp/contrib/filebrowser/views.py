...
from bp.contrib.filebrowser.functions import path_to_url, sort_by_attr, get_path, get_file, get_version_path, get_breadcrumbs, get_filterdate, get_settings_var, handle_file_upload, convert_filename
from bp.contrib.filebrowser.templatetags.fb_tags import query_helper
from bp.contrib.filebrowser.base import FileObject
from bp.contrib.filebrowser.decorators import flash_login_required
...
def mkdir(request):
    ...
    from bp.contrib.filebrowser.forms import MakeDirForm
...
def rename(request):
    ...
    from bp.contrib.filebrowser.forms import RenameForm
...
def versions(request):
    ...
    return render_to_response('filebrowser/versions.html', {
        ...
        'h1': _(u'Versions for "%s"') % filename,
        'menu_current': 'content_media',
        'settings_var': get_settings_var(),
        'breadcrumbs': get_breadcrumbs(query, path),
