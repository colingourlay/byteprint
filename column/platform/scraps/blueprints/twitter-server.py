...
# 
#     name = 'twitter-server'
#     display_name = 'Twitter (Server-Side)'
#     preview = True
#     fields = {
#         'username': forms.CharField(
#             required = False,
#             label = "Twitter User",
#             help_text = "Enter the name of the Twitter user who's timeline you wish to \
#                 display."
#         ),
#         'password': forms.CharField(
#             required = False,
#             label = "Twitter Password",
#             help_text = "If the above user's Twitter timeline is not public, \
#                 you need to enter a password to authenticate the user.",
#             scrap = forms.PasswordInput()
#         ),
#         'num_tweets': forms.IntegerField(
#             required = False,
#             label = "Number of Tweets",
#             help_text = "The number of tweets you want to be displayed inside \
#                 the scrap. If you leave this blank, the scrap will display \
...
#             if scrap_data['password']:
#                  api = Api(scrap_data['username'], scrap_data['password'])
#             else:
#                 api = Api(scrap_data['username'])
#             try:
#                 tweets = api.GetUserTimeline(scrap_data['username'])
#             except Exception, e:
#                 return "<!-- Twitter API connection error -->"
#             num_tweets = 1
#             if scrap_data['num_tweets']:
#                 num_tweets = int(scrap_data['num_tweets'])
